"""
pipeline/plot_composite_recursive_lines.py -- plot.py with a recursion-aware palette.
...
`aggregate_composite_recursive.py --split-components`:
...
line-chart counterpart of pipeline/plot_composite_recursive_stack.py (which takes the raw
...
Usage:
    ...
    $PY pipeline/plot_composite_recursive_lines.py --csv results/recursive_par.csv \\
