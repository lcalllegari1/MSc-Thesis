"""
pipeline/plot_composite_recursive_stack.py -- recursion-specific component bar charts.
...
Input is the RAW recursion CSV (pipeline/run_composite_recursive.py output: one row per
...
Usage:
    ...
    $PY pipeline/plot_composite_recursive_stack.py --csv results/recursion.csv \\
        --k 2 --out plots/recursion_components

    # pick metrics / format / fixed exp:
    $PY pipeline/plot_composite_recursive_stack.py --csv results/recursion.csv --k 2 \\
