...
Production mode:
  ...
  --exp 2   Recursively verify ALL K segments of a K-way split AND fold in the
            full glue logic (outer circuit = circuits/recursion, generic over K).
...
The harness reuses the UNMODIFIED hierarchical_segment_fs circuit as the inner (the *plain*
