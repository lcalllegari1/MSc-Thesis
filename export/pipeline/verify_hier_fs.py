"""
pipeline/verify_hier_fs.py — Variant A++ hierarchical verifier.
...
Difference from Variant A's verify_hier.py:
...
Usage:
    python pipeline/verify_hier_fs.py --proof-dir <dir> --n 8 --k 2 \
...
def verify_hier_fs(proof_dir: Path, n: int, k: int, sub_vk: Path, glue_vk: Path) -> int:
    ...
    print(f"verify_hier_fs: N={n} K={k} M={m}")
...
def main():
    ...
    sys.exit(verify_hier_fs(args.proof_dir, args.n, args.k, args.sub_vk, args.glue_vk))
