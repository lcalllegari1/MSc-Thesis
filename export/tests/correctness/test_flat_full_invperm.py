"""
tests/correctness/test_flat_full_invperm.py

Soundness tests for circuits/flat_full_invperm.
...
CIRCUIT_DIR  = PROJECT_ROOT / "circuits" / "flat_full_invperm"
...
def main():
    print("Soundness tests: circuits/flat_full_invperm")
    print("=" * 52)
