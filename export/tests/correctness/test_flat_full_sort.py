"""
tests/correctness/test_flat_full_sort.py

Soundness tests for circuits/flat_full_sort.
...
The circuit under test enforces three constraint groups:
  GROUP 2  sort-based permutation:  sorted(cycle) == [0, 1, ..., N-1]
           (GROUP 1 range check from flat_full_pairwise is subsumed here)
...
CIRCUIT_DIR  = PROJECT_ROOT / "circuits" / "flat_full_sort"
...
def run_tests_n5():
    ...
    # In flat_full_sort, GROUP 1 (range check) is subsumed by GROUP 2.
...
def main():
    print("Soundness tests: circuits/flat_full_sort")
    print("=" * 52)
