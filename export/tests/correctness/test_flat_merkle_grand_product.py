"""
tests/correctness/test_flat_merkle_grand_product.py

Soundness tests for circuits/flat_merkle_grand_product.
...
This is the grand-product counterpart of test_flat_merkle_sort/presence: GROUP 3
...
CIRCUIT_DIR   = PROJECT_ROOT / "circuits" / "flat_merkle_grand_product"
...
def main():
    print("Soundness tests: circuits/flat_merkle_grand_product")
    print("=" * 56)
    ensure_builder()
