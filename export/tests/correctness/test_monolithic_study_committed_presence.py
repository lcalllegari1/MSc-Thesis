"""
tests/correctness/test_monolithic_study_committed_presence.py

Soundness tests for circuits/monolithic_study_committed_presence.
...
The circuit enforces four constraint groups:
  ...
  GROUP 2  presence check:  seen[cycle[i]] == false before marking it true
           (identical to monolithic_study_presence; GROUP 1 is explicit, not subsumed)
...
Usage:
    python tests/correctness/test_monolithic_study_committed_presence.py
...
CIRCUIT_DIR   = PROJECT_ROOT / "circuits" / "monolithic_study_committed_presence"
...
def main():
    print("Soundness tests: circuits/monolithic_study_committed_presence")
    print("=" * 56)
