...
(tests/recursion_micro/run_recursion.py output) into a plot.py-compatible CSV
...
-----
  python pipeline/aggregate_recursion.py \\
      --in  results/recursion_micro.csv \\
...
def main():
    ap = argparse.ArgumentParser(
        description="Aggregate raw recursion_micro CSV into a plot.py-compatible CSV.")
    ap.add_argument("--in", dest="inp", required=True, type=Path,
                    help="Input CSV from tests/recursion_micro/run_recursion.py")
