"""
pipeline/plot_recursion_modes.py -- recursion-only PARALLEL vs TOTAL gap.
...
--mode-in-name, this reads the RAW recursion CSV (run_recursion.py output) and
...
from plot_recursion_lines import _color_for_k  # K-aware palette (shared)
