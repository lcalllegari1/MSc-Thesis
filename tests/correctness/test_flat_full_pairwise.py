"""
tests/correctness/test_flat_full_pairwise.py

Soundness tests for circuits/flat_full_pairwise.
...
CIRCUIT_DIR  = PROJECT_ROOT / "circuits" / "flat_full_pairwise"
...
def main():
    print("Soundness tests: circuits/flat_full_pairwise")
    print("=" * 52)
